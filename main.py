...
Round(image=round_img, sniper_max_ammo=5, launcher_ammo=1, sniper_zoom=2, round_time=45, round_music=SoundManager.game_music1,
      horizon_line=2600, spawn_chance=1 / 200, headers=['Round 1', "Let's go"]).play_round()


round_img_path = 'media/photos/second_round.jpg'
round_img = cv.imread(round_img_path)
Round(image=round_img, sniper_max_ammo=5, launcher_ammo=1, sniper_zoom=5, round_time=45, round_music=SoundManager.game_music3,
      horizon_line=1500, spawn_chance=1 / 200, headers=['Round 2', 'Wrong scope :(']).play_round()

round_img_path = 'media/photos/third_round.jpg'
round_img = cv.imread(round_img_path)
Round(image=round_img, sniper_max_ammo=1, launcher_ammo=2, sniper_zoom=3, round_time=45, round_music=SoundManager.game_music4,
