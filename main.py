...
Round(image=round_img, sniper_max_ammo=5, launcher_ammo=1, sniper_zoom=2, time=45, round_music=game_music1,
      horizon_line=2600, spawn_rate=1/200, headers=['Round 1', "Let's go"]).play_round()
...
Round(image=round_img, sniper_max_ammo=5, launcher_ammo=1, sniper_zoom=5, time=45, round_music=game_music3,
      horizon_line=1500, spawn_rate=1/200, headers=['Round 2', 'Wrong scope :(']).play_round()
...
Round(image=round_img, sniper_max_ammo=1, launcher_ammo=2, sniper_zoom=3, time=45, round_music=game_music4,
      horizon_line=2500, spawn_rate=1/200, headers=['Round 3', 'No magazine!']).play_round()
...
Round(image=round_img, sniper_max_ammo=1000, launcher_ammo=3, sniper_zoom=1, time=120, round_music=game_music2,
      horizon_line=1800, spawn_rate=1/50, headers=['Last Round', 'Seiko Mode']).play_round()
