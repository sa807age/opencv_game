...
sounds_folder = 'media/sounds' if os.path.exists('media/sounds') else '../media/sounds'
...
death_sound3 = pygame.mixer.Sound(os.path.join(sounds_folder, 'death_sounds', 'death_sound3.mp3'))
death_sound3.set_volume(0.5)

death_sound4 = pygame.mixer.Sound(os.path.join(sounds_folder, 'death_sounds', 'death_sound4.mp3'))
death_sound4.set_volume(0.5)

death_sound5 = pygame.mixer.Sound(os.path.join(sounds_folder, 'death_sounds', 'death_sound5.mp3'))
death_sound5.set_volume(0.5)

death_sound6 = pygame.mixer.Sound(os.path.join(sounds_folder, 'death_sounds', 'death_sound6.mp3'))
death_sound6.set_volume(0.5)

death_sound7 = pygame.mixer.Sound(os.path.join(sounds_folder, 'death_sounds', 'death_sound7.mp3'))
death_sound7.set_volume(0.5)

death_sound8 = pygame.mixer.Sound(os.path.join(sounds_folder, 'death_sounds', 'death_sound8.mp3'))
