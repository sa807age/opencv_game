...
class Zombie:
    ...
    def get_bbox(self):
        ...
        """
        return [math.ceil(self.location[0] - 10 * self.size),
                math.ceil(self.location[1] - 20 * self.size),
                math.ceil(20 * self.size),
                math.ceil(40 * self.size)]
    ...
    def draw_arrow(self, frame, aim):
        ...
        cv.line(frame, arrow_point, [int(arrow_point[0]) + int(rotated_vector1[0]),
                                     int(arrow_point[1]) + int(rotated_vector1[1])], arrow_color, 10)
        cv.line(frame, arrow_point, [int(arrow_point[0]) + int(rotated_vector2[0]),
                                     int(arrow_point[1]) + int(rotated_vector2[1])], arrow_color, 10)
    ...
    def draw_body(self, photo, relative_location: list):
        """
        Draw the zombie's body on the photo.
        ...
        cv.line(photo, [relative_location[0], relative_location[1] + math.ceil(3 * self.size)],
                ...
                self.color, math.ceil(1 + self.size))
        cv.line(photo, [relative_location[0], relative_location[1] + math.ceil(3 * self.size)],
    ...
    def draw_face(self, photo, relative_location: list):
        """
        Draw the zombie's face on the photo.
